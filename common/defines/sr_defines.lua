...
NDefines.NGame.GAME_SPEED_SECONDS = { 0.20, 0.15, 0.1, 0.06, 0.0 } -- 0.375, 0.175, 0.1, 0.035, 0.0 game speeds for each level. Must be 5 entries with last one 0 for unbound
---------------------------------------------------------------
